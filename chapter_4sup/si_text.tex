\section{Time weighted net growth rates}\label{ssec:netgrowth}
...
%%%%%%%%%%%%%%%%%%%%%%
\pagebreak
\section{Quantifying Light Noise}\label{ssec:lightnoise}
...
\section{Drug conditions and response functions}
...
%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%
\section{Bliss independence}\label{ssec:bliss}
...
%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%
\section{Loewe additivity}\label{ssec:loewe}
...
\section{Peptide--antibiotic interaction model}\label{ssec:toy_model}
...
\section{Condition-wise interaction inference on the checkerboard}\label{ssec:bootstrap_interactions}
...
%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Continuous interaction surfaces and geometric exploration}\label{ssec:surface}
...
%%%%%%%%%%%%%%%% vi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Single-drug inoculum effect analysis}\label{ssec:inoculum}
