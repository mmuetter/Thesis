...
\begin{table}
  ...
  \begin{tabular}{lll}
    \toprule
    \textbf{Name} & \textbf{Relevant phenotype} & \textbf{Reference} \\
    \midrule
    \textit{Escherichia coli} MDS42-YFP & Cm\textsuperscript{R} & \cite{Feher2012} \\
    A-resistant & Cm\textsuperscript{R} pA (Amp\textsuperscript{R}, Caz\textsuperscript{R}) & this study, \cite{Huisman2022} \\
    B-resistant & Cm\textsuperscript{R} pB (Amp\textsuperscript{R}, Tet\textsuperscript{R}) & this study, \cite{Huisman2022} \\
    AB-resistant & Cm\textsuperscript{R} pA (Amp\textsuperscript{R}, Caz\textsuperscript{R}) pB (Amp\textsuperscript{R}, Tet\textsuperscript{R}) & this study, \cite{Huisman2022} \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{SCtable}[50]
  \raggedright
  \caption{Definition of resistance profiles (rows) by growth patterns on differently treated \textit{agar plates} (columns). X indicates colony formation, whereas o indicates no growth.}
...
\begin{SCtable}
  \raggedright
  \caption{Association between bacterial phenotypes (rows) and resistance profiles \(\phi\) (columns). An 'X' denotes that a phenotype is obligatory for a given profile, while a '\(\surd\)' indicates that it is optional.}
...
\begin{SCtable}[50]
  \raggedright
  \caption{Clearance probability of well phenotypes across the three experiments.}
  \label{tab:clearance}
  \makeCSVtable{r|ccc}%
  { & $S$ & $A_r$ & $B_r$ }%
