...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{chapter_2/end_anova.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{chapter_2/scen3_paper.pdf}
  \captionsetup{skip=2pt}
  \caption{
...
\begin{figure}[t]
  ...
  \begin{tabular}{@{}c c@{}}
    \begin{minipage}{0.6\textwidth}
      \includegraphics[height=4cm]{chapter_2/20220412_f_emergence_anova.pdf}
      \vspace{4pt}
      \includegraphics[height=4cm]{chapter_2/20220412_encounter_frequencies.pdf}
      \vspace{4pt}
      \includegraphics[height=4cm]{chapter_2/20220412_conjugation_prop.pdf}
    \end{minipage}
    &
...
\includegraphics[width=\textwidth]{chapter_2/wins_and_losses_preexisting.pdf}
\vspace{4pt}
\includegraphics[width=\textwidth]{chapter_2/wins_and_losses_no_preex.pdf}
\end{minipage}
&
