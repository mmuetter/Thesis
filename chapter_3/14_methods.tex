...
Primers are listed in \autoref{tab:primers}.
...
All MICs, determined by broth microdilution (\cite{EUCAST2025}), and the concentrations used are listed in \autoref{tab:drugs}.
...
We estimated the width and length of the bacterial cells using a custom Python script, as described in \autoref{ssec:experiments}.
