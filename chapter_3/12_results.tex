...
\(\ddagger\) Carbapenems tend to deform cells into a lemon-like shape (\autoref{fig:micro_mero}), resulting in poor fitting quality since our algorithm assumes a cylindrical geometry. \vspace{.6cm}
}
