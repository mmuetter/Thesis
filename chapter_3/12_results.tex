...
These illustrative simulations were conducted using an initial division rate $\lambda_0 = 1.5\,\mathrm{h}^{-1}$. More details and all parameter values can be found in \autoref{sec:model}.}
