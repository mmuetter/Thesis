...
\begin{figure}
\centering
\begin{minipage}{11.54cm}
\hfill
\begin{overpic}[width=10.9cm]{chapter_3sup/figures/filamentation_summary_pre.pdf}
\put(-.5,15){\small\bfseries a)}
\end{overpic}
\vspace{-2mm}
\begin{overpic}[width=11.4cm]{chapter_3sup/figures/filamentation_summary_post.pdf}
