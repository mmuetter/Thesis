...
\begin{table}[H]
  ...
  \input{supplementary_1/tables/man_ferroni}
...
\begin{table}[H]
  ...
  \input{supplementary_1/tables/loss_data}
  \label{tab:loss_data}
\end{table}
...
\begin{table}[H]
  ...
  \input{supplementary_1/tables/growthcurves_and_rates.tex}
\end{table}
...
\begin{table}[H]
  ...
  \begin{minipage}{.82\linewidth} % Adjust the width as needed
    ...
    \input{supplementary_1/tables/best_stats_no_preex}
  ...
  \begin{minipage}{.82\linewidth} % Adjust the width as needed
    ...
    \input{supplementary_1/tables/worst_stats_no_preex}
  ...
  \begin{minipage}{.82\linewidth} % Adjust the width as needed
    ...
    \input{supplementary_1/tables/best_stats_preexisting}
  ...
  \begin{minipage}{.82\linewidth} % Adjust the width as needed
    ...
    \input{supplementary_1/tables/worst_stats_preexisting}
...
\begin{table}[H]
  ...
  \resizebox{\linewidth}{!}{
    \input{supplementary_1/tables/win_loss_statistic_preexisting}
  }
  ...
  \resizebox{\linewidth}{!}{
    \input{supplementary_1/tables/win_loss_statistic_no_preex}
  }
  ...
  \resizebox{\linewidth}{!}{
    \input{supplementary_1/tables/win_loss_statistic_clean_preexisting}
  }
  ...
  \resizebox{\linewidth}{!}{
    \input{supplementary_1/tables/win_loss_statistic_clean_no_preex}
  }
